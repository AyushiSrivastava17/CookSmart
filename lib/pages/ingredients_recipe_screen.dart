...
class RecipeIngredientsPage extends StatefulWidget {
  ...
  final Meal meal;
  final SearchIngredients searchIngred;

  RecipeIngredientsPage({this.mealType, this.recipe, this.meal, this.searchIngred});

  @override
  State createState() {
    return new RecipeIngredientsPageState();
  }
}

class RecipeIngredientsPageState extends State<RecipeIngredientsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        initialUrl: widget.searchIngred.sourceUrl,
